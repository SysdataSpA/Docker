...
- (UIImage*) sd_resize : (CGSize)newSize roundCorner:(CGFloat)roundCorner quality:(CGInterpolationQuality)quality {
    return [self sd_resize:newSize fillType:UIImageResizeFillTypeIgnoreAspectRatio
...
- (UIImage*) sd_resizeFillIn : (CGSize)newSize roundCorner:(CGFloat)roundCorner quality:(CGInterpolationQuality)quality {
    return [self sd_resize:newSize fillType:UIImageResizeFillTypeFillIn
             topLeftCorner:roundCorner topRightCorner:roundCorner bottomRightCorner:roundCorner bottomLeftCorner:roundCorner quality:quality];
}

- (UIImage*) sd_resizeFitIn : (CGSize)newSize roundCorner:(CGFloat)roundCorner quality:(CGInterpolationQuality)quality {
    return [self sd_resize:newSize fillType:UIImageResizeFillTypeFitIn
             topLeftCorner:roundCorner topRightCorner:roundCorner bottomRightCorner:roundCorner bottomLeftCorner:roundCorner quality:quality];
}
...
- (void) sd_applyLinearGradient:(CGFloat)direction components:(CGFloat*)components context:(CGContextRef)context
{
...
- (UIImage*) sd_imageWithLinearGradient:(CGFloat)direction intensity:(CGFloat)intensity
{
    ...
    return [self sd_imageWithLinearGradient:direction components:components];
}
...
- (UIImage*) sd_imageWithLinearGradient:(CGFloat)direction components:(CGFloat*)components
{
    ...
    // apply gradient
    [self sd_applyLinearGradient:direction components:components context:UIGraphicsGetCurrentContext()];
...
{
    return [maskImage sd_imageWithOverlay:self blendMode:kCGBlendModeSourceIn alpha:1.0 scale:NO];
}
